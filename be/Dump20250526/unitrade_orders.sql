...
CREATE TABLE `orders` (
  ...
  KEY `prod_id` (`prod_id`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`seller_id`) REFERENCES `users` (`user_id`),
...
INSERT INTO `orders` VALUES (10001,1002,1001,1002,'2025-04-29',NULL);
...
-- Dump completed on 2025-05-26 12:55:04
